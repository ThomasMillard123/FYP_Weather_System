...
ExpVar g_SunLightIntensity("Viewer/Lighting/Sun Light Intensity", 1.0f, 1.0f, 14.0f, 0.1f);
...
{
    desheap.Create(L"IMGUI", D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 4096);
...
void ModelViewer::RenderScene( void )
{
  ...
  //      // Begin rendering depth
    ...
    GraphicsContext& gfxContexta = GraphicsContext::Begin(L"Imgui"); 
    gfxContexta.TransitionResource(g_OverlayBuffer, D3D12_RESOURCE_STATE_RENDER_TARGET, true);
    gfxContexta.ClearColor(g_OverlayBuffer);
    gfxContexta.SetRenderTarget(g_OverlayBuffer.GetRTV());
    gfxContexta.SetViewportAndScissor(0, 0, g_OverlayBuffer.GetWidth(), g_OverlayBuffer.GetHeight());
    ImGuiA::ImGuiManager::Instance()->Render(gfxContexta, desheap.GetHeapPointer());
